pretty html json or real json
two ways to use
 standalone, jetty in dev, get the war for prod (how to make your own war)
 use in rack applicatoin (has to be running under jruby)
 how to build, runlocally

How to run arbitray code? ~/.neo4jr-social or 
('neo4jr.extensions') || ENV['neo4jr_extensions']
...
You need to either install jruby or if you used a utility like rvm then your jruby executable may actually be called jruby-1.4, if this is the case create an alias somewhere in your PATH like:
